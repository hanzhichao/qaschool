    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(db_index=True, max_length=200, unique=True, verbose_name='栏目网址')),
                ('sn', models.IntegerField(null=True, verbose_name='排序')),
                ('intro', models.CharField(blank=True, max_length=200, null=True, verbose_name='栏目简介')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('column', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.Column', verbose_name='所属栏目')),
            ],
            options={
                'verbose_name': '课程',
